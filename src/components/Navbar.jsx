      ...
      <div className="flex md:gap-3 gap-1 items-center">
        ...
        <div className="flex-none">
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={-1}
              className="menu menu-sm md:menu-md dropdown-content 
                         bg-gray-900 text-gray-200 rounded-xl z-1 mt-3 w-44 p-2 
            ...
            >
              ...
              <li className="hover:bg-gray-700 rounded-lg duration-300">
                <button
                  onClick={toggleTheme}
                  className="flex items-center justify-between text-[12px] md:text-sm text-left hover:text-white duration-300"
                >
